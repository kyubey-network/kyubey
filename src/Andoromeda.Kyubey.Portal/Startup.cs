    ...
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITokenRepository, TokenFileInfoRepository>()
                .AddTransient<ITokenAPIRopository, TokenAPIRopository>();
            ...
            {
                x.AddCulture(new string[] { "en", "en-US", "en-HK", "en-GB", "en-us", "en-hk", "en-gb" }, new JsonLocalizedStringStore(Path.Combine("Localization", "en-US.json")));
